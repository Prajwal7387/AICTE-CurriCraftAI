      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 bg-slate-50/80 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 space-y-4 shadow-xl">
          ...
          <form onSubmit={handleGenerateSyllabus} className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-slate-800 dark:text-slate-300 mb-1">Course Title *</label>
              <input
                type="text"
                required
                value={courseTitle}
                onChange={(e) => setCourseTitle(e.target.value)}
                className="w-full px-3.5 py-2.5 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs text-slate-900 dark:text-white focus:outline-none focus:border-violet-500"
              />
            </div>

            <div>
              <label className="block text-xs font-bold text-slate-800 dark:text-slate-300 mb-1">Engineering Branch *</label>
              <input
                type="text"
                required
                value={branch}
        ...
        <div className="lg:col-span-5 bg-slate-50/80 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 space-y-4 shadow-xl">
          ...
          <form onSubmit={handleRewriteOutcome} className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-slate-800 dark:text-slate-300 mb-1">Original Outcome Draft *</label>
              <textarea
                rows={3}
                required
                value={outcomeText}
            ...
            <div>
              <label className="block text-xs font-bold text-slate-800 dark:text-slate-300 mb-1">Target Bloom Cognitive Level</label>
              <select
                value={targetBloom}
