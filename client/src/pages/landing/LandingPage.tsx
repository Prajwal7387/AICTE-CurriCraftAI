...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 bg-radial-grid text-slate-900 dark:text-slate-100 flex flex-col relative overflow-hidden">
      ...
      <header className="h-20 border-b border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl sticky top-0 z-50 px-6 lg:px-12 flex items-center justify-between shadow-2xl">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            <div>
              <span className="font-extrabold text-xl text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
                CurriCraft <span className="text-[10px] font-bold text-violet-700 dark:text-violet-300 uppercase tracking-widest px-2 py-0.5 rounded-full bg-violet-500/15 border border-violet-500/30">AICTE AI</span>
              </span>
        ...
        <div className="flex items-center space-x-4">
          <Link
            to="/portal"
            className="hidden sm:inline-flex items-center space-x-1.5 px-4 py-2 rounded-xl text-xs font-semibold text-slate-800 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100/60 dark:hover:bg-slate-800/60 transition-colors"
          >
      ...
      <main className="flex-1 max-w-7xl mx-auto px-6 lg:px-12 py-16 space-y-24 relative z-10">
        <div className="text-center space-y-6 max-w-4xl mx-auto pt-8">
          <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-violet-500/10 border border-violet-500/30 text-violet-700 dark:text-violet-300 text-xs font-bold tracking-wide uppercase backdrop-blur-md">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 dark:text-white tracking-tight leading-tight">
            Unified AICTE Model Curriculum Portal Powered by <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 via-violet-500 to-emerald-500 dark:from-cyan-400 dark:via-violet-400 dark:to-emerald-400">Generative AI</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <Link
              to="/portal"
              className="w-full sm:w-auto px-8 py-4 bg-slate-50/90 dark:bg-slate-900/90 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-900 dark:text-slate-200 text-sm font-bold rounded-2xl border border-slate-300/80 dark:border-slate-700/80 flex items-center justify-center space-x-2 transition-all cursor-pointer"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="w-12 h-12 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-500 dark:text-amber-400">
                <Award className="w-6 h-6 text-amber-500 dark:text-yellow-400" />
              </div>
              <ArrowRight className="w-4 h-4 text-slate-500 group-hover:text-cyan-500 dark:group-hover:text-cyan-400 group-hover:translate-x-1 transition-all" />
            </div>
            <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-violet-700 dark:group-hover:text-cyan-300 transition-colors">NEP 2020 Compliance Engine</h3>
            ...
            <span className="inline-flex items-center gap-1 text-[11px] font-bold text-violet-700 dark:text-violet-400 group-hover:underline pt-1">
              Launch Audit Engine →
            </span>
          </div>
          ...
          >
            ...
            <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-violet-700 dark:group-hover:text-cyan-300 transition-colors">Google Gemini AI Synthesis</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <span className="inline-flex items-center gap-1 text-[11px] font-bold text-emerald-700 dark:text-emerald-400 group-hover:underline pt-1">
              Open AI Assistant →
            </span>
          </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="w-12 h-12 rounded-2xl bg-purple-500/10 border border-purple-500/30 flex items-center justify-center text-purple-500 dark:text-purple-400">
                <FileCode className="w-6 h-6 text-cyan-500 dark:text-cyan-400" />
              </div>
              <ArrowRight className="w-4 h-4 text-slate-500 group-hover:text-cyan-500 dark:group-hover:text-cyan-400 group-hover:translate-x-1 transition-all" />
            </div>
            <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-violet-700 dark:group-hover:text-cyan-300 transition-colors">Git-Style Version Snapshots</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <span className="inline-flex items-center gap-1 text-[11px] font-bold text-cyan-700 dark:text-cyan-400 group-hover:underline pt-1">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="w-12 h-12 rounded-2xl bg-cyan-500/10 border border-cyan-500/30 flex items-center justify-center text-cyan-500 dark:text-cyan-400">
                <CheckSquare className="w-6 h-6 text-emerald-500 dark:text-emerald-400" />
              </div>
              <ArrowRight className="w-4 h-4 text-slate-500 group-hover:text-cyan-500 dark:group-hover:text-cyan-400 group-hover:translate-x-1 transition-all" />
            </div>
            <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-violet-700 dark:group-hover:text-cyan-300 transition-colors">AICTE Bureau Governance</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
              Multi-tiered review workflows (`DRAFT` → `SUBMITTED` → `APPROVED` → `PUBLISHED`) with peer committee feedback and instant publishing.
            </p>
            <span className="inline-flex items-center gap-1 text-[11px] font-bold text-purple-700 dark:text-purple-400 group-hover:underline pt-1">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="w-12 h-12 rounded-2xl bg-rose-500/10 border border-rose-500/30 flex items-center justify-center text-rose-500 dark:text-rose-400">
                <Globe className="w-6 h-6 text-rose-500 dark:text-rose-400" />
              </div>
              <ArrowRight className="w-4 h-4 text-slate-500 group-hover:text-cyan-500 dark:group-hover:text-cyan-400 group-hover:translate-x-1 transition-all" />
            </div>
            <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-violet-700 dark:group-hover:text-cyan-300 transition-colors">Public Adoption Portal</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <span className="inline-flex items-center gap-1 text-[11px] font-bold text-rose-700 dark:text-rose-400 group-hover:underline pt-1">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="w-12 h-12 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-500 dark:text-amber-400">
                <Building className="w-6 h-6 text-amber-500 dark:text-amber-400" />
              </div>
              <ArrowRight className="w-4 h-4 text-slate-500 group-hover:text-cyan-500 dark:group-hover:text-cyan-400 group-hover:translate-x-1 transition-all" />
            </div>
            <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-violet-700 dark:group-hover:text-cyan-300 transition-colors">Role-Based Access Control</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <span className="inline-flex items-center gap-1 text-[11px] font-bold text-amber-700 dark:text-amber-400 group-hover:underline pt-1">
        ...
        {/* Statistics Banner */}
        <div className="bg-gradient-to-r from-slate-900 via-slate-900 to-slate-950 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-2xl flex flex-col md:flex-row items-center justify-around gap-6 text-center text-white">
          <div>
            <p className="text-4xl font-extrabold text-cyan-400">12+</p>
            <p className="text-xs font-semibold text-slate-300 uppercase tracking-wider mt-1">Engineering Disciplines</p>
          </div>
          <div className="hidden md:block w-px h-12 bg-slate-800"></div>
          <div>
            <p className="text-4xl font-extrabold text-emerald-400">100%</p>
            <p className="text-xs font-semibold text-slate-300 uppercase tracking-wider mt-1">NEP 2020 Alignment</p>
          </div>
          <div className="hidden md:block w-px h-12 bg-slate-800"></div>
          <div>
            <p className="text-4xl font-extrabold text-amber-400">1,500+</p>
            <p className="text-xs font-semibold text-slate-300 uppercase tracking-wider mt-1">Affiliated Colleges</p>
          </div>
        </div>
      </main>
