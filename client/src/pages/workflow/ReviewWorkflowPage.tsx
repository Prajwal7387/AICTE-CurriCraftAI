                  ...
                  <div key={curr._id} className="p-4 bg-white dark:bg-slate-950 border border-purple-500/20 hover:border-purple-500/40 rounded-xl space-y-3 shadow-md transition-all">
                    ...
                    <div className="flex items-center space-x-2 pt-2 border-t border-slate-200 dark:border-slate-800">
                      <button
                        ...
                        className="flex-1 py-1.5 bg-emerald-600/20 hover:bg-emerald-600 text-emerald-400 hover:text-slate-900 dark:text-white text-xs font-bold rounded-lg border border-emerald-500/30 flex items-center justify-center gap-1 transition-all"
                      >
                      ...
                      <button
                        ...
                        className="flex-1 py-1.5 bg-amber-600/20 hover:bg-amber-600 text-amber-400 hover:text-slate-900 dark:text-white text-xs font-bold rounded-lg border border-amber-500/30 flex items-center justify-center gap-1 transition-all"
                      >
                ...
                deniedCurricula.map((curr) => (
                  <div key={curr._id} className="p-4 bg-white dark:bg-slate-950 border border-amber-500/30 rounded-xl space-y-3 shadow-md transition-all">
                    ...
                    <button
                      ...
                      className="w-full py-1.5 bg-slate-100 dark:bg-slate-800 hover:bg-amber-600 text-slate-800 dark:text-slate-300 hover:text-slate-900 dark:text-white text-xs font-bold rounded-lg border border-slate-300 dark:border-slate-700 hover:border-amber-500 transition-all flex items-center justify-center gap-1.5"
                    >
                ...
                approvedCurricula.map((curr) => (
                  <div key={curr._id} className="p-4 bg-white dark:bg-slate-950 border border-emerald-500/30 rounded-xl space-y-3 shadow-md transition-all">
                    ...
                    <button
                      ...
                      className="w-full py-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-slate-900 dark:text-white text-xs font-bold rounded-lg flex items-center justify-center space-x-1.5 shadow-lg shadow-emerald-600/20 transition-all"
                    >
          ...
          <div className="bg-slate-50 dark:bg-slate-900 border border-amber-500/40 rounded-3xl max-w-lg w-full p-6 shadow-2xl space-y-5 animate-in fade-in zoom-in duration-150">
            ...
            <form onSubmit={handleConfirmRequestEdits} className="space-y-4">
                ...
                <div className="space-y-1.5 max-h-36 overflow-y-auto pr-1">
                  {presetFeedbackOptions.map((opt, idx) => (
                    <button
                      ...
                      className="w-full text-left p-2 rounded-lg bg-white dark:bg-slate-950 hover:bg-amber-950/40 border border-slate-200 dark:border-slate-800 hover:border-amber-500/40 text-[11px] text-slate-800 dark:text-slate-300 hover:text-amber-200 transition-all"
                    >
                      + {opt}
                    </button>
                  ))}
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-200 dark:border-slate-800">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-gradient-to-r from-amber-600 to-red-600 hover:from-amber-500 hover:to-red-500 text-slate-900 dark:text-white text-xs font-bold rounded-xl shadow-lg flex items-center gap-1.5"
                >
