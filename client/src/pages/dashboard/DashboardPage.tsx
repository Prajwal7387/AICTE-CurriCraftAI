      ...
      <div className="bg-gradient-to-r from-brand-900/60 via-slate-900 to-slate-900 border border-brand-500/20 rounded-2xl p-6 shadow-xl relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="px-4 py-2.5 bg-brand-600 hover:bg-brand-500 text-slate-900 dark:text-white text-xs font-semibold rounded-xl shadow-lg shadow-brand-600/30 flex items-center space-x-2 transition-all hover:scale-105"
          >
          ...
          <Link
            to="/ai-assistant"
            className="px-4 py-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:bg-slate-700 text-slate-900 dark:text-slate-200 text-xs font-semibold rounded-xl border border-slate-300 dark:border-slate-700 flex items-center space-x-2 transition-all"
          >
            ...
            <tbody className="divide-y divide-slate-800/60">
              {filteredCurricula.length > 0 ? (
                filteredCurricula.map((curr) => (
                  <tr key={curr._id} className="hover:bg-slate-100/40 dark:bg-slate-800/40 transition-colors">
                    ...
                    <td className="p-3 text-right space-x-2">
                      <button
                        ...
                        className="px-3 py-1 bg-brand-600/20 hover:bg-brand-600 text-brand-300 hover:text-slate-900 dark:text-white rounded text-[11px] font-medium transition-colors border border-brand-500/30 inline-flex items-center gap-1"
                      >
                        <span>Workspace</span>
